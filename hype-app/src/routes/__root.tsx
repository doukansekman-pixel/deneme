...
const DEFAULT_TITLE = "Hype Bar - Shisha, Cocktails & Ladies Night in Stadtallendorf";
const DEFAULT_DESCRIPTION =
  "Die Karte der Hype Bar in Stadtallendorf: Shisha, Cocktails, Snacks, Adresse und Öffnungszeiten.";
...
// The site's canonical origin, used to make og:image/og:video absolute per
// the SEO audit. This app runs on its own VPS (Node/Docker), not Higgsfield
// hosting - update this once a domain is decided (see design-brief.md).
const SITE_ORIGIN = "http://187.124.171.105";
...
function buildHead(meta: AppMeta) {
  ...
  return {
    meta: [
      ...
      { property: "og:site_name", content: "Hype Bar" },
