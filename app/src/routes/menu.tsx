...
const CARD_SCRIM =
  "radial-gradient(ellipse 46% 52% at 50% 50%, rgba(13,11,9,0.5) 0%, rgba(13,11,9,0.16) 68%, transparent 100%)";
  ...
  return (
    <div>
      <div className="relative flex min-h-[220px] items-end overflow-hidden rounded border border-vb-border p-7">
        ...
        <div
          aria-hidden
          className="absolute inset-0 bg-gradient-to-t from-[#18120e]/92 via-[#18120e]/15 to-transparent"
        />
        <button
          onClick={onBack}
