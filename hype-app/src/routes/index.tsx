...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "Hype Bar - Shisha, Cocktails & Ladies Night in Stadtallendorf" },
      {
        name: "description",
        content:
    ...
    <section className="bg-vb-accent py-20 text-vb-bg">
      <div className="mx-auto grid max-w-5xl items-center gap-8 px-6 md:grid-cols-[1fr_1.1fr_1fr]">
        ...
        <Reveal3D delay={240}>
          <TiltImage
            src={image2}
            alt="Lounge-Bereich der Hype Bar"
            loading="lazy"
            className="aspect-[3/4] w-full rounded-md object-cover"
          />
        </Reveal3D>
  ...
  return (
    <section id="visit" className="relative isolate border-t border-vb-border">
      ...
      <div className="mx-auto grid max-w-5xl gap-10 px-6 py-20 md:grid-cols-2">
        ...
        {address ? (
          <iframe
            title="Hype Bar auf Google Maps"
            ...
            src="https://www.google.com/maps?q=Hype+Bar+Stadtallendorf,+Niederkleiner+Str.+44,+35260+Stadtallendorf&z=16&output=embed"
  ...
  return (
    <div className="font-vb-display">
      ...
      <ScrollDepthHero
        ...
        imageAlt="Blick in die Hype Bar: warmes Licht und Lounge-Atmosphäre"
